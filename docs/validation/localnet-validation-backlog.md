...
| Q8 | Will sponsored tx dual-sign flow work without EVE Vault? | MEDIUM — gas abstraction claim | Verify test server sponsorship mechanism. May need custom sponsor service. |
