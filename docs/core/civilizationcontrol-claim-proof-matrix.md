...
| Tribe filter allows matching tribes | Devnet test — PLAYER_A (tribe 1) granted AccessGrant object + 1 SUI toll transferred | shortlist-viability-validation-report.md Test 3 | Devnet checkpoint ~6260 (sandbox); `[TBD-digest]` (submission) | Green "Access Granted" overlay + AccessGrant event |
